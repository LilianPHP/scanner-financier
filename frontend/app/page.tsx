  ...
  return (
    <main className="min-h-screen bg-[#f5f5f2]">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-20">
        <p className="text-center text-xs text-gray-400 uppercase tracking-widest mb-6">Aperçu du résultat</p>
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white">
          ...
          {/* Dashboard UI */}
          <div className="bg-[#f5f5f2] p-4 md:p-6">
            {/* Header */}
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm font-medium">Voilà où va ton argent</p>
              <div className="flex gap-2">
                <span className="text-xs bg-white border border-gray-200 rounded-lg px-2 py-1 text-gray-400">148 transactions</span>
                <span className="text-xs border border-gray-200 rounded-lg px-2 py-1 text-gray-400 bg-white">Historique</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <div className="flex gap-3 mt-2 justify-center">
                  <span className="flex items-center gap-1 text-[10px] text-gray-500"><span className="w-2 h-2 rounded-sm bg-[#1D9E75] inline-block" />Revenus</span>
                  <span className="flex items-center gap-1 text-[10px] text-gray-500"><span className="w-2 h-2 rounded-sm bg-[#E24B4A] inline-block" />Dépenses</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              <p className="text-xs font-medium mb-3">Transactions <span className="text-gray-400 font-normal">(148)</span></p>
              <div className="space-y-0 divide-y divide-gray-100">
                {[
                  ...
                  <div key={tx.label} className="flex items-center gap-3 py-2 text-xs">
                    <span className="text-gray-400 w-10 flex-shrink-0">{tx.date}</span>
                    <span className="flex-1 text-gray-700">{tx.label}</span>
