...
export default function Confidentialite() {
  return (
    <main className="min-h-screen bg-[#f5f5f2] px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 space-y-8 text-sm text-gray-600 leading-relaxed">

          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Ce qu'on collecte</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Ce qu'on ne collecte pas</h2>
            <ul className="mt-2 space-y-1 list-disc list-inside text-gray-500">
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Comment tes données sont utilisées</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Stockage et sécurité</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Intelligence artificielle</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Tes droits</h2>
        ...
        <p className="text-xs text-gray-400 text-center mt-6">Dernière mise à jour : mars 2026</p>
      </div>
    </main>
  )
}
