    ...
    <main className="min-h-screen bg-[#f5f5f2] px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 space-y-8 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Éditeur du site</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Hébergement</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Propriété intellectuelle</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Limitation de responsabilité</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-gray-900 mb-3">Droit applicable</h2>
